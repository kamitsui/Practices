...
/*   Updated: 2023/07/17 16:33:34 by kamitsui         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(int ac, char *av[])
{
    ...
    // Create a new window
    win_ptr = mlx_new_window(mlx_ptr, WIN_WIDTH, WIN_HEIGHT, "wireframe");
    if (win_ptr == NULL) {
	...
	// Create a new image
	data.img = mlx_new_image(mlx_ptr, IMG_WIDTH, IMG_HEIGHT);
	...
	// Put pixel
	mlx_put_image_to_window(mlx_ptr, win_ptr, data.img, 100, 100);
